...
use madversal\simplereport\libs\CortexPE\DiscordWebhookAPI\Embed;
use madversal\simplereport\libs\CortexPE\DiscordWebhookAPI\Message;
use madversal\simplereport\libs\CortexPE\DiscordWebhookAPI\Webhook;
...
class Main extends PluginBase {
    ...
    public function onEnable(): void {
        ...
        //$this->getLogger()->info("SimpleReport has been enabled successfully!"); poggit remove?
    }
    ...
    public function notifyAdmins(string $reporter, string $reported, string $reason): void {
      ...
      */
                ...
                $embed->setColor(mt_rand(0x000000, 0xFFFFFF)); // This add the random color
                $embed->setFooter("¡New report has been submited!");
                $msg->addEmbed($embed);
                $webHook->send($msg);                    
            }
        }
